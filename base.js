(function () {
    ...
    function createInitialElements() {
        ...
        ctn_pig.innerHTML = `
            ...
            background="transparent" speed="1" style="width: 270px; height: 270px" loop autoplay></dotlottie-player>
        ...
        ctn_input.style = `
            flex: 1;align-items: center; border-radius: 5px; display: flex;flex-direction: row;gap: 20px;padding: 10px;background-color: #151F3B;
        `
        ...
        const_ct_bet.appendChild(ctn_input)

        const btn_bet = document.createElement('button')
        btn_bet.style = `cursor: pointer; border-radius: 5px; color: white; padding: 0px 20px;border: 0px; font-size: 18px; font-family: "Merienda", serif; font-weight: 700;outline:none;height: 55px;background-image: linear-gradient(${color.top_neon}, ${color.bot_neon})`
        btn_bet.textContent= "Play"
        const_ct_bet.appendChild(btn_bet)
